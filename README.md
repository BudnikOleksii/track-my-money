...
.
├── apps
│   ├── api-shared                       # NestJS app (https://nestjs.com).
...
# See `@track-my-money/eslint-config` to customize the behavior.
pnpm run lint
```
...
# See `@track-my-money/eslint-config/prettier-base.js` to customize the behavior.
pnpm format
```
